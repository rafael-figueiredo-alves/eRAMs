...
Const
 ...
 SQL_LISTA_ALUNOS2  : string = 'and ((Mat.flg_Mat = ''MP'') or (Mat.flg_mat = ''PM'')) and (Alu.cod_alu = mat.cod_alu) and (datediff(day, alu.dat_nas, getdate()) < 6574) ORDER BY Alu.Nom_alu';
